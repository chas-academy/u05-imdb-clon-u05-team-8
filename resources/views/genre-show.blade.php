...
<div class="bg-green-100 border border-green-200 overflow-hidden rounded-md">
    <div class="px-4 py-5 sm:px-6">
        ...
        &nbsp;&nbsp;
        <form class="text-sm font-medium" onsubmit="return confirm('Do you really want to delete? ({{$genre['name']}})');" action="{{ action([App\Http\Controllers\GenreController::class, 'destroy'], ['genre'=>$genre])}}" method="POST">
            @method('DELETE')
            @csrf
